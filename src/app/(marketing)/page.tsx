...
export default function MarketingPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-900 to-gray-800">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <div className="text-center">
          ...
          <div className="mt-10 flex justify-center gap-4">
            ...
            <Link 
              href="/login" 
              className="px-8 py-3 bg-gray-800 border border-gray-600 rounded-lg hover:bg-gray-700 transition-all duration-300 text-lg font-medium"
            >
              Sign In
            </Link>
          </div>
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8">
          {[
            ...
            <div key={index} className="bg-gray-800 p-6 rounded-xl shadow-sm border border-gray-700">
              <div className="flex items-center justify-center w-12 h-12 bg-gray-900/20 rounded-lg mb-4">
                {feature.icon}
              </div>
      ...
      {/* How It Works */}
      <section className="py-20 bg-gray-800/50 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl font-bold text-center text-white mb-12">How ThinkBetter Works</h2>
              ...
              {[
                ...
                <div key={index} className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="mt-1text-gray-400">{step.description}</p>
                  </div>
                </div>
              ))}
            </div>
            ...
            <div className="bg-gray-700 p-6 rounded-xl shadow-sm border border-gray-600">
              <div className="aspect-video bg-gradient-to-br from-gray-600 to-gray-700 rounded-lg flex items-center justify-center">
                <div className="text-center p-8">
                  ...
                  <h3 className="mt-4 text-lg font-medium text-white">Decision Making Process</h3>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto text-center">
        <h2 className="text-3xl font-bold text-white mb-6">Ready to Make Better Decisions?</h2>
