            ...
            >
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3 p-4 bg-blue-900/20 rounded-lg">
                  ...
                  <div>
                    <h3 className="font-medium text-blue-200">Improve Decision Quality</h3>
                    <p className="text-sm text-blue-300">
                      Consider adding weight factors to pros and cons based on importance
                    </p>
                  </div>
                </div>
                <div className="flex items-start space-x-3 p-4 bg-yellow-900/20 rounded-lg">
                  <AlertTriangle size={20} className="mt-1" />
                  <div>
                    <h3 className="font-medium text-yellow-200">Bias Check</h3>
                ...
                <div className="flex items-start space-x-3 p-4 bg-green-900/20 rounded-lg">
                  <Lightbulb size={20} className="mt-1" />
                  <div>
                  <h3 className="font-medium text-green-200">Next Level</h3>
