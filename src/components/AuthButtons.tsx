  ...
  if (!user) {
    return (
      <motion.button
        ...
        className="flex items-center justify-center cursor-pointer gap-3 px-4 py-2 rounded-lg bg-white text-gray-900 hover:bg-gray-50 transition-colors border border-gray-200 shadow-sm font-medium"
        whileTap={{ scale: 0.98 }}
      >
